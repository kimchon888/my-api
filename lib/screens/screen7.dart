...
import 'package:homework/screens/screen8.dart'; // Import Screen8
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            const SizedBox(height: 120), // chính lại height: 60, nếu dùng trên giao diện chính
            const SizedBox(height: 100), // chỉnh lại height: 100, trên giao diện điện thoại chính
            Container(
              child: const Row(
                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                children: [
